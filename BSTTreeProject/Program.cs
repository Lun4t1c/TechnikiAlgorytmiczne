...
namespace BSTTreeProject
{
    public static class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            TestSetSplay(FirstSet, Utilities.FIRST_SPLAY_REPORT_FILE_PATH);
            TestSetSplay(SecondSet, Utilities.SECOND_SPLAY_REPORT_FILE_PATH);
            TestSetSplay(ThirdSet, Utilities.THIRD_SPLAY_REPORT_FILE_PATH);
        }
        ...
        public static void TestSetSplay(string[] set, string operationsFilePath)
        {
            Console.WriteLine("Testing set splay...");
            string fileContent = "";
